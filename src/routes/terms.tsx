...
export const Route = createFileRoute("/terms")({
  ...
  component: () => (
    <LegalPage title="Terms of Service" updated="May 2026">
      ...
      <p>Third-party embed hosts operate independently and are governed by their own terms. We make no warranty about availability, legality in your jurisdiction, or quality of any embed.</p>
      <h2>4. No warranty</h2>

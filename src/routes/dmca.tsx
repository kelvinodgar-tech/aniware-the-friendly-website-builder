...
export const Route = createFileRoute("/dmca")({
  head: () => ({
    meta: [
      { title: "DMCA — Aniware" },
      { name: "description", content: "DMCA takedown notice procedure for Aniware." },
    ],
  }),
  component: () => (
    <LegalPage title="DMCA Notice" updated="May 2026">
      <p>
        Aniware does <strong>not</strong> host any video content. All playable embeds load from
      ...
      <h2>To remove an embed from Aniware</h2>
      <p>If you'd like us to also remove the embed listing from our catalog, send the following to <a href="mailto:dmca@aniware.app">dmca@aniware.app</a>:</p>
      <ul>
        <li>Identification of the copyrighted work (title, episode).</li>
        <li>The exact URL on Aniware where it appears.</li>
